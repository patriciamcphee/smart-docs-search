...
const Search = () => {
  ...
  const renderSearchResult = (result, index) => {
    ...
    }, result.title), result.previewContent && /*#__PURE__*/_react.default.createElement("div", {
      className: _stylesModule.default.resultDescription
    }, result.previewContent), result.last_update && /*#__PURE__*/_react.default.createElement("div", {
