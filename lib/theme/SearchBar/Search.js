...
const Search = () => {
  ...
  const handleKeyDown = (0, _react.useCallback)(e => {
    ...
    switch (e.key) {
      ...
      case 'Tab':
        ...
        const newIndex = e.shiftKey ? Math.max(-1, selectedIndex - 1) : Math.min(searchResults.length - 1, selectedIndex + 1);
  ...
  const handleResultFocus = (0, _react.useCallback)(index => {
    setSelectedIndex(index);
    setIsFocused(true);
  }, []);
  const handleResultBlur = (0, _react.useCallback)(() => {
    setIsFocused(false);
  }, []);
  ...
  const renderSearchResult = (result, index) => {
    ...
    return /*#__PURE__*/(0, _jsxRuntime.jsx)("div", {
      ...
      children: result.type === 'document' ? /*#__PURE__*/(0, _jsxRuntime.jsxs)(_jsxRuntime.Fragment, {
        children: [/*#__PURE__*/(0, _jsxRuntime.jsx)("div", {
          className: _stylesModule.default.resultTitle,
          children: highlightText(result.title, result.searchTerm)
        }), result.previewContent && /*#__PURE__*/(0, _jsxRuntime.jsx)("div", {
          className: _stylesModule.default.resultDescription,
          children: highlightText(result.previewContent, result.searchTerm)
        }), result.last_update && /*#__PURE__*/(0, _jsxRuntime.jsxs)("div", {
          className: _stylesModule.default.resultMeta,
          children: [formatDate(result.last_update)?.date && `Last updated: ${formatDate(result.last_update).date}`, formatDate(result.last_update)?.author && ` by ${formatDate(result.last_update).author}`]
        })]
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsxs)("div", {
    ...
    children: [/*#__PURE__*/(0, _jsxRuntime.jsxs)("div", {
      ...
      children: [isExpanded ? /*#__PURE__*/(0, _jsxRuntime.jsx)(_antd.Tooltip, {
      ...
      }) : /*#__PURE__*/(0, _jsxRuntime.jsx)(_icons.SearchOutlined, {
        className: _stylesModule.default.searchIcon,
        onClick: toggleSearch
    ...
    }), isExpanded && searchTerm && /*#__PURE__*/(0, _jsxRuntime.jsxs)("div", {
      id: "search-results",
      ...
      children: [/*#__PURE__*/(0, _jsxRuntime.jsx)("div", {
        ...
        children: searchResults.length === 0 ? 'No results found' : `Found ${searchResults.length} result${searchResults.length === 1 ? '' : 's'}`
